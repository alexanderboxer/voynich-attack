"""Build the sentence-level CSV for Plinius maior, Naturalis historia (c. 79).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12197.

Corpus: Auctores scientiarum varii
Author: Plinius maior
Work:   Naturalis historia

Polyglot disclosure: 1 body row contains Greek; `textstring_simple` empty for it.
"""
