"""Build the sentence-level CSV for Fronto, Epistulae (c. 160).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12181.

Corpus: Auctores scientiarum varii
Author: Fronto
Work:   Epistulae

Polyglot disclosure: ~79 body rows are Greek (mostly Homer quotations
in Fronto's correspondence with Marcus Aurelius). These have non-empty
