"""Build the sentence-level CSV for Ps-Caesar, De bello Hispaniensi (c. -42).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12148.

Corpus: Auctores scientiarum varii
Author: Ps-Caesar
Work:   De bello Hispaniensi
"""
