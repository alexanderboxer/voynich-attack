"""Build the sentence-level CSV for Ps-Caesar, De bello Alexandrino (c. -42).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12147.

Corpus: Auctores scientiarum varii
Author: Ps-Caesar
Work:   De bello Alexandrino
"""
