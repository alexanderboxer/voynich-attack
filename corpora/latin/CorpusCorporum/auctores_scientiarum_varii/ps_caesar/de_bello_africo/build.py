"""Build the sentence-level CSV for Ps-Caesar, De bello Africo (c. -42).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12146.

Corpus: Auctores scientiarum varii
Author: Ps-Caesar
Work:   De bello Africo
"""
