"""Build the sentence-level CSV for Pomponius Mela, De chorographia (c. 100).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12150.

Corpus: Auctores scientiarum varii
Author: Pomponius Mela
Work:   De chorographia
"""
