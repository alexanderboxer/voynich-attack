"""Build the sentence-level CSV for Dicuil, De mensura orbis terrae (c. 900).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12160.

Corpus: Auctores scientiarum varii
Author: Dicuil
Work:   De mensura orbis terrae
"""
