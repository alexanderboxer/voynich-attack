"""Build the sentence-level CSV for Solinus, De mirabilibus mundi (c. 400).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12161.

Corpus: Auctores scientiarum varii
Author: Solinus
Work:   De mirabilibus mundi
"""
