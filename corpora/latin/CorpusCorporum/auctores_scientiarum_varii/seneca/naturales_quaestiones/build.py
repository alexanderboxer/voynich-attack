"""Build the sentence-level CSV for Seneca, Naturales quaestiones (c. AD 65; natural philosophy).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12196.
