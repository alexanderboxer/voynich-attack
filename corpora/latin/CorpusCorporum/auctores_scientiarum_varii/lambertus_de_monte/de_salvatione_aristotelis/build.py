"""Build the sentence-level CSV for Lambertus de Monte, De salvatione Aristotelis (c. 1499).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12170.

Corpus: Auctores scientiarum varii
Author: Lambertus de Monte
Work:   De salvatione Aristotelis

Polyglot disclosure: 2 body rows contain Greek; `textstring_simple` empty for these.
"""
...
CC_IDNO = "12170"
STEM = "de_salvatione_aristotelis"
