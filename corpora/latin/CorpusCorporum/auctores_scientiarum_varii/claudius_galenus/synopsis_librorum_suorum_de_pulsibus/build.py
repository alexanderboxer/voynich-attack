"""Build the sentence-level CSV for Claudius Galenus, Synopsis librorum suorum de pulsibus (c. 199).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 21603.
...
CC_IDNO = "21603"
STEM = "synopsis_librorum_suorum_de_pulsibus"
