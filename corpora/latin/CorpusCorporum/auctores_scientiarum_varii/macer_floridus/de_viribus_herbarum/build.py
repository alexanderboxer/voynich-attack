"""Build the sentence-level CSV for Macer Floridus, De viribus herbarum (c. 1100; medieval Latin herbal poem).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12173.
