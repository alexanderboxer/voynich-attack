"""Build the sentence-level CSV for Anonymus, Rhetorica ad Herennium (c. 0).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12206.

Corpus: Auctores scientiarum varii
Author: Anonymus
Work:   Rhetorica ad Herennium
"""
