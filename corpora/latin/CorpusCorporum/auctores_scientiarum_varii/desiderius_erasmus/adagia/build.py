"""Build the sentence-level CSV for Desiderius Erasmus, Adagia (c. 1536).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12132.

Corpus: Auctores scientiarum varii
Author: Desiderius Erasmus
Work:   Adagia

Polyglot disclosure: ~2,040 body rows (~4% of total) carry Greek
proverbs cited alongside Erasmus's Latin commentary. These rows have
non-empty `textstring_orig` but empty `textstring_simple` (the Latin-
only normalization strips non-ASCII), so Latin-alphabet analyses
