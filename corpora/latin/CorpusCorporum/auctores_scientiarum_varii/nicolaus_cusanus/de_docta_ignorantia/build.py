"""Build the sentence-level CSV for Nicolaus Cusanus, De docta ignorantia (c. 1464).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12154.

Corpus: Auctores scientiarum varii
Author: Nicolaus Cusanus
Work:   De docta ignorantia
"""
