"""Build the sentence-level CSV for Nicolaus Cusanus, Idiota de mente (c. 1464).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12188.

Corpus: Auctores scientiarum varii
Author: Nicolaus Cusanus
Work:   Idiota de mente
"""
