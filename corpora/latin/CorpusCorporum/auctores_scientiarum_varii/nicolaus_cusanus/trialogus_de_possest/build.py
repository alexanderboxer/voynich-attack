"""Build the sentence-level CSV for Nicolaus Cusanus, Trialogus de possest (c. 1464).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12215.

Corpus: Auctores scientiarum varii
Author: Nicolaus Cusanus
Work:   Trialogus de possest
"""
