"""Build the sentence-level CSV for Witelo, De perspectiva (lib. 1) (c. 1275).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12165.

Corpus: Auctores scientiarum varii
Author: Witelo
Work:   De perspectiva (lib. 1)
"""
