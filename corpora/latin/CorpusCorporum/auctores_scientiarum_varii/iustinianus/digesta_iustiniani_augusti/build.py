"""Build the sentence-level CSV for Iustinianus, Digesta Iustiniani Augusti (c. 565).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12178.

Corpus: Auctores scientiarum varii
Author: Iustinianus
Work:   Digesta Iustiniani Augusti

Polyglot disclosure: ~121 body rows are Greek imperial rescripts
embedded in the Latin legal compilation. These have non-empty
`textstring_orig` but empty `textstring_simple`.
"""
...
CC_IDNO = "12178"
STEM = "digesta_iustiniani_augusti"
