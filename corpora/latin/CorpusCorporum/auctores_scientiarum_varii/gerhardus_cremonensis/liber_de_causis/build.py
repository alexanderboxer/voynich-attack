"""Build the sentence-level CSV for Gerhardus Cremonensis, Liber de causis (c. 1187).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12191.

Corpus: Auctores scientiarum varii
Author: Gerhardus Cremonensis
