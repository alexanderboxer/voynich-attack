"""Build the sentence-level CSV for Frontinus, Sextus Iulius, Strategemata (c. 103).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12210.

Corpus: Auctores scientiarum varii
Author: Frontinus, Sextus Iulius
Work:   Strategemata
"""
