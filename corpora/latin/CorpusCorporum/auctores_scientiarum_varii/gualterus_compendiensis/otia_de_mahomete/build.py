"""Build the sentence-level CSV for Gualterus Compendiensis, Otia de Mahomete (c. 1101).

Source: Corpus Corporum (mlat.uzh.ch), cc_idno 12202.

Corpus: Auctores scientiarum varii
Author: Gualterus Compendiensis
Work:   Otia de Mahomete
"""
