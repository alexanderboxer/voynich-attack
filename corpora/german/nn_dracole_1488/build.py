"""Build the sentence-level CSV for the 1488 Dracole print (DTA id nn_dracole_1488).

Second print of the Dracole wyda tyrant narrative (cf. nn_dracole_1485).
"""
