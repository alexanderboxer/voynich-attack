"""Build the sentence-level CSV for Ellenbog, Von den gifftigen temmpffen (1524).

Early German treatise on toxic vapors/mining-related illnesses
(Ulrich Ellenbog, Augsburg).
"""
