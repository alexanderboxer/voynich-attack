"""Build the sentence-level CSV for Kuchemaistrey (1490).

Early printed German cookbook (Peter Wagner, Nürnberg).
This DTA-pipeline version replaces the older hand-coded version in
corpora/german/kuchemaistrey/.
"""
