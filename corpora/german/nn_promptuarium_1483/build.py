"""Build the sentence-level CSV for Promptuarium Medicinae, niederdeutsch (1483).

Low German medical reference work (Bartholomäus Ghotan, Magdeburg).
This DTA-pipeline version replaces the older hand-coded version in
corpora/german/promptuarium_medicinae/.
"""
...
DOC_ID = "nn_promptuarium_1483"
XML_PATH = HERE / f"{DOC_ID}.TEI-P5.xml"
