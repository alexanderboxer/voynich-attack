"""Build the sentence-level CSV for Brunfels 1531 *Apodixis Germanica*.

Pilot text for the corpus_build pipeline.
"""
...
DOC_ID = "brunfels_apodixis_1531"
XML_PATH = HERE / f"nn_{DOC_ID}.TEI-P5.xml"
