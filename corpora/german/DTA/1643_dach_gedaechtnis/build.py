"""Build the sentence-level CSV for Dach, Gedächtnis bey adelicher Leichbestattung Dem Weila (1643)."""
...
def main() -> None:
    ...
    # fragments ("mehr", "uon", author-signature "Simon Dachen") too short
    # to contribute useful sentence statistics.
    n_demoted = 0
    for r in rows:
