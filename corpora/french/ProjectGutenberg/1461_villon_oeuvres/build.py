"""Build sentence-level CSV for Villon Œuvres complètes (c. 1461).

Source: Project Gutenberg #12246, Pierre Jannet ed. (La Monnoye, 1854).
Text preserves period 15th-c. orthography; editorial apparatus is excluded
via ``manifest.json``'s ``start_line`` / ``end_line`` bounds.
"""
