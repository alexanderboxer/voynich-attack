...
# alphaplus assert
abc36 = 'abcdefghijlmnopqrstuvxyzàãçèéëïóõüũẽ'
allowed_charset = set(abc36).union(set(nonalpha_keepers)).union(set(' '))
assert len(set(s_alphaplus).difference(allowed_charset)) == 0

# alpha assert
allowed_charset = set(abc36).union(set(' '))
